#!/bin/sh
#SBATCH --job-name=small_religiosa_na_5km
#SBATCH --nodes=1
...
#SBATCH --output=/home/yshin/mendel-nas1/religiosa_nsdm_HPC/models_run/small/namerica_5km/log/small_religiosa_na_5km_%j-%x.log
#SBATCH --error=/home/yshin/mendel-nas1/religiosa_nsdm_HPC/models_run/small/namerica_5km/err/small_religiosa_na_5km_%j-%x.err
